...
# sent_alp_li　= ['p', 'o', 's', ' ', 'p', 'o', 's', ' ', 'h', 'e', 'l', 'l', 'o', ' ', ' ', 'b', 'a', 'r', '\n', 'f', 'o', 'o', ' ', 'b', 'a', 'r', ' ', 'f', 'o', 'o', ' ', 'p', 'o', 's', ' ', 'k', 'i', 'n', ' ', 'p', 'o', 's', '\n', 't', 'e', 's', 't', ' ', 't', 'e', 's', 't', ' ', 'p', 'o', 's']
# sent_word_li = ['pos', 'pos', 'hello', 'bar', 'foo', 'bar', 'foo', 'pos', 'kin', 'pos', 'test', 'test', 'pos']
